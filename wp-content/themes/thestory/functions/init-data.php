...
if ( !function_exists( 'pexeto_define_custom_pages' ) ) {
	...
	function pexeto_define_custom_pages() {
		...
		$fullpage_hide = array(
			'textimg' => array('text_layout', 'images'),
			'text'=>array('image_layout', 'images', 'content_image'),
			'slider'=>array('text_layout', 'image_layout', 'slide_background_image', 'background_color',
				'slide_title', 'slide_description', 'content_image', 'button_text', 'button_link', 'slide_style',
		...
		$pexeto->custom_pages=array( 
			...
			new PexetoCustomPage( PEXETO_FULLPAGESLIDER_POSTTYPE, array(
				array('id'=>'slide_type', 'name'=>'Slide Type', 'type'=>'select', 'two-column'=>'first', 'options'=>array(
						...
						array('id' => 'textimg', 'name'=>'Text + Image', 'hide'=>$fullpage_hide['textimg']),
						array('id' => 'slider', 'name' => 'Image Slider', 'hide'=>$fullpage_hide['slider'])
					)),
				array('id'=>'text_layout', 'name'=>'Layout', 'type'=>'select', 'two-column'=>'last-one', 'options'=>array(
						array('id'=>'cc', 'name' => 'Center'),
						array('id'=>'ct', 'name' => 'Center - Top'),
						array('id'=>'cb', 'name' => 'Center - Bottom'),
						array('id'=>'lt', 'name' => 'Left - Top'),
						array('id'=>'lc', 'name' => 'Left - Center'),
						array('id'=>'lb', 'name' => 'Left - Bottom'),
						array('id'=>'rt', 'name' => 'Right - Top'),
						array('id'=>'rc', 'name' => 'Right - Center'),
						array('id'=>'rb', 'name' => 'Right - Bottom')
					)),
				...
				array( 'id'=>'slide_style', 'type'=>'select', 'name'=>'Slide Style', 'options'=>array(
						array('id'=>'default', 'name'=> 'Default Style', 'hide'=>$fullpage_hide['default_style']),
						array('id'=>'custom', 'name'=> 'Custom Style')
					)),
				...
				array( 'id'=>'button_color', 'type'=>'colorpick', 'name'=>'Button Color' ),
